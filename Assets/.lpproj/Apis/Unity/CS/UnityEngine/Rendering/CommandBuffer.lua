...
---@param projectionMat : CS.UnityEngine.Matrix4x4[]
function CS.UnityEngine.Rendering.CommandBuffer:SetLateLatchProjectionMatrices(projectionMat)
end

---@param matrixPropertyType : CS.UnityEngine.Rendering.CameraLateLatchMatrixType
---@param shaderPropertyID : CS.System.Int32
function CS.UnityEngine.Rendering.CommandBuffer:MarkLateLatchMatrixShaderPropertyID(matrixPropertyType, shaderPropertyID)
end

---@param matrixPropertyType : CS.UnityEngine.Rendering.CameraLateLatchMatrixType
function CS.UnityEngine.Rendering.CommandBuffer:UnmarkLateLatchMatrix(matrixPropertyType)
end
